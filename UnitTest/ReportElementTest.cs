...
namespace UnitTest
{
    ...
    public class ReportElementTest
    {
        ...
        {
            var element = new ReportElement { Tag = HtmlTag.div, Content = "Teste", HtmlProperties = new string[] { "class='test'", "style='color:black;'" } };
        ...
        {
            var element1 = new ReportElement { Tag = HtmlTag.div, HtmlProperties = new string[] { "class='test'", "style='color:black;'" } };
            var element2 = new ReportElement { Tag = HtmlTag.div, Content = "Teste", HtmlProperties = new string[] { "class='test'", "style='color:red;'" } };
